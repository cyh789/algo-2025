...
public class Solution_260304_dfs_2 {
    ...
    public static int solution(int n, int[][] computers) {
        ...
        for (int v1 = 0; v1 < n; v1++) {
            ...
            dfs(visited, n, computers, v1);
            result++;
        }
        return result;
    }

    private static void dfs(boolean[] visited, int n, int[][] computers, int v1) {
        visited[v1] = true;
        for (int v2 = 0; v2 < n; v2++) {
            if (visited[v2]) continue;
            if (computers[v1][v2] != 1) continue;
            visited[v2] = true;
            dfs(visited, n, computers, v2);
        }
    }
}