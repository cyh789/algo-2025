...
public class Solution_260319_dfs {
    ...
    public static int solution(int n, int[][] computers) {
        ...
        for (int v1 = 0; v1 < n; v1++) {
            ...
            visited[v1] = true;
            dfs(n, computers, v1, visited);
            result++;
        }
        return result;
    }

    private static void dfs(int n, int[][] computers, int v1, boolean[] visited) {
        for (int v2 = 0; v2 < n; v2++) {
            if (computers[v1][v2] != 1) continue;
            if (visited[v2]) continue;
            visited[v2] = true;
            dfs(n, computers, v2, visited);
        }
    }
}