...
public class Solution_260309_bfs {
    ...
    private static int bfs(String begin, String target, String[] words) {
        ...
        while (!q.isEmpty()) {
            ...
            for (int i = 0; i < words.length; i++) {
                String next = words[i];
                if (!chkFunc(currStr, next)) continue;
    ...
    private static final class Node {
        ...
        private Node(String begin, int cnt) {
            this.begin = begin;
            this.cnt = cnt;
        }
