...
public class Solution_260310_bfs {
    ...
    private static int bfs(String begin, String target, String[] words) {
        ...
        q.add(new String[]{begin, String.valueOf(cnt)});
        boolean[] visited = new boolean[words.length];
        while (!q.isEmpty()) {
            String[] temp = q.poll();
            String curr = temp[0];
            int currCnt = Integer.valueOf(temp[1]);

            if (curr.equals(target)) return currCnt;
            ...
            for (int i = 0; i < words.length; i++) {
                ...
                visited[i] = true;
                q.add(new String[]{next, String.valueOf(currCnt + 1)});
            }
        }
