package com.algo.backup.programmers.prog_08.prog_0808_016_카드_뭉치;
...
public class Solution {
    ...
    public static String solution(String[] cards1, String[] cards2, String[] goal) {
        ...
        //map card1, 2
        //idx card1, 2
        //boolean reverse = false  =>  true 면 card2 idx2++
        ...
        for (int i = 0; i < goal.length; i++) {
            ...
            if (map1.containsKey(selected) && map1.get(selected) == idx1) idx1++;
            else if (map2.containsKey(selected) && map2.get(selected) == idx2) idx2++;
            else return "No";
        }
