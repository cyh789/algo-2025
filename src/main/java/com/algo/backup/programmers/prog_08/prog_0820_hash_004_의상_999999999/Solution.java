package com.algo.backup.programmers.prog_08.prog_0820_hash_004_의상_999999999;
...
public class Solution {
    ...
    public static int solution(String[][] clothes) {
        ...
        for (String[] cloth : clothes) {
            String name = cloth[1];
            map.put(name, map.getOrDefault(name, 1) + 1);   //1부터 시작 : 안 입는 경우도 포함
        }
        ...
        return sum - 1;     //1제외 : 전부 안입는 경우인 1을 제외
    }
}
