package com.algo.backup.programmers.prog_08.prog_0822_hash_005_베스트앨범_999999999;
...
class Solution {
    ...
    public static int[] solution(String[] genres, int[] plays) {
        Map<String, Integer> genreMap = new HashMap<>();    //장르명, totalcnt
        Map<String, Map<Integer, Integer>> songMap = new HashMap<>();    //장르명, song<index, cnt>
        ...
        List<String> genreList = new ArrayList<>(genreMap.keySet());    //장르명
        genreList.sort((o1, o2) -> genreMap.get(o2) - genreMap.get(o1));

        List<Integer> answer = new ArrayList<>();
        for (String name : genreList) {
            Map<Integer, Integer> song = songMap.get(name);

            List<Integer> songList = new ArrayList<>(song.keySet());  //index
