package com.algo.backup.programmers.prog_08.prog_0821_queueNstack_105_다리를_지나는_트럭;
    ...
    public static int solution(int bridge_length, int weight, int[] truck_weights) {
        ...
        while (true) {
            ...
            if (bridgeQueue.isEmpty()) {
                ...
                //더 넣을 수 있는 경우
                if (weight >= currentBridgeWeight + truck_weights[truckIndex]) {
                    //offer 신규트럭
                    bridgeQueue.offer(selected);
                    currentBridgeWeight += truck_weights[truckIndex];
                    truckIndex++;
        ...
        return timeOfferCount + bridge_length;
    }
}
