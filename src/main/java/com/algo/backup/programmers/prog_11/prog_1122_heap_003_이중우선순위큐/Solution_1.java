package com.algo.backup.programmers.prog_11.prog_1122_heap_003_이중우선순위큐;
...
public class Solution_1 {
    ...
    public static void main(String[] args) {
        ...
        n[index++] = new String[]{"I 16", "I -5643", "D -1", "D 1", "D 1", "I 123", "D -1"};
    ...
    public static int[] solution(String[] operations) {
        ...
        for (String operation : operations) {
            ...
            if ("I".equals(operationTemp[0])) {
                max.add(Integer.parseInt(operationTemp[1]));
                min.add(Integer.parseInt(operationTemp[1]));
            } else {
                if ("1".equals(operationTemp[1])) {
                    min.remove(max.poll());
                } else {
                    max.remove(min.poll());
                }
        ...
        return max.isEmpty() ? new int[]{0, 0} : new int[]{max.poll(), min.poll()};
    }
}
