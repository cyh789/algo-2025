package com.algo.backup.programmers.prog_09.prog_0922_graph_006_전력망을_둘로_나누기;
...
public class Solution {
    ...
    public static int solution(int n, int[][] wires) {
        ...
        for (int[] arr : wires) {
            ...
            //System.out.println("v1=" + v1 + " / v2=" + v2 + " / minCount=" + minCount + " / diff=" + diff + " / cntV1=" + cntV1 + " / cntV2=" + cntV2);
