package com.algo.backup.programmers.prog_09.prog_0925_hash_005_베스트앨범_999999999;
...
class Solution {
    ...
    public static int[] solution(String[] genres, int[] plays) {
        ...
        //  ㄴ장르 내에서 많이 재생된 노래를 먼저 수록합니다.
        Map<String, Map<Integer, Integer>> genreSongCountMap = new HashMap<>(); // string genreName, int totalCount
        //  ㄴ장르 내에서 재생 횟수가 같은 노래 중에서는 고유 번호가 낮은 노래를 먼저 수록합니다.
        //Map<Integer, Integer> songCountMap = new HashMap<>(); // string songIndex, int count
        ...
        List<String> genreNameList = new ArrayList<>(genreTotalCountMap.keySet());
        genreNameList.sort((o1, o2) -> genreTotalCountMap.get(o2) - genreTotalCountMap.get(o1));
        ...
        for (String genreName : genreNameList) {
            Map<Integer, Integer> songCountMap = genreSongCountMap.get(genreName); // string songIndex, int count
            List<Integer> songIndexList = new ArrayList<>(songCountMap.keySet());
            songIndexList.sort((o1, o2) -> songCountMap.get(o2) - songCountMap.get(o1));
