package com.algo.backup.programmers.prog_09.prog_0926_graph_007_모음사전;
...
public class Solution {
    ...
    public static int solution(String word) {
        ...
        result = 0;
        cnt = 0;
        dfs(word, words, curr, depth, visited);
    ...
    private static void dfs(String word, String[] words, String curr, int depth, boolean[] visited) {
        if (depth == 6) return;
        ...
        for (int i = 0; i < words.length; i++) {
            ...
            dfs(word, words, next, depth + 1, visited);
