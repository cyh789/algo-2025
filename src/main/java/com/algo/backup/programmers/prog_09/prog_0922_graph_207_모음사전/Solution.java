package com.algo.backup.programmers.prog_09.prog_0922_graph_207_모음사전;
...
public class Solution {
    ...
    private static void dfs(String word, String[] words, String curr, int depth) {
        if (curr.equals(word)) {
            answer = count;
            return;
        }
