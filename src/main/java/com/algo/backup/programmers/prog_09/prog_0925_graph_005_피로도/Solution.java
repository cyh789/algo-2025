package com.algo.backup.programmers.prog_09.prog_0925_graph_005_피로도;
...
public class Solution {
    ...
    public static int solution(int k, int[][] dungeons) {
        ...
        int curr = k;
        int index = 0;
        dfs(dungeons, curr, index, visited);
    ...
    private static void dfs(int[][] dungeons, int curr, int index, boolean[] visited) {
        if (index == 8) {
            return;
        }
