package com.algo.backup.programmers.prog_09.prog_0930_heap_002_디스크_컨트롤러;
    ...
    public static int solution(int[][] jobs) {
        ...
        while (pollCnt < jobs.length) {
            ...
            if (!pq.isEmpty()) {
                ...
                int reqTime = selected[0];
                int transTime = selected[1];
                sum += endTime + transTime - reqTime;
                endTime += transTime;
            } else {
                // 큐가 비어있으면 다음 작업 요청 시각으로 시간 이동
