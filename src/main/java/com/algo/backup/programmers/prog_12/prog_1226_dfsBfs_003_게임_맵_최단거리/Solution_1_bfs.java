...
public class Solution_1_bfs {
    ...
    private static int bfs(int[][] maps) {
        ...
        int cnt = 1;
        q.add(new Node(new int[]{0, 0}, cnt));
        ...
        while (!q.isEmpty()) {
            ...
            //System.out.println("currCnt=" + currCnt + " / curr=" + Arrays.toString(curr));
            ...
            for (int i = 0; i < dx.length; i++) {
                ...
                q.add(new Node(new int[]{nextX, nextY}, currCnt + 1));
            }
        }
    ...
    private static final class Node {
        ...
        public boolean equals(Object obj) {
            ...
            var that = (Node) obj;
            return Objects.equals(this.curr, that.curr) &&
                    this.cnt == that.cnt;
        }

        @Override
        public int hashCode() {
            return Objects.hash(curr, cnt);
        }
