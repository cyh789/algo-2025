package com.algo.backup.programmers.prog_10.prog_1010_dfsBfs_003_게임_맵_최단거리;
...
public class Solution {
    ...
    public static int solution(int[][] maps) {
        ...
        dfs(maps, dx, dy, 0, 0, visited, 1); // 시작점 포함해서 move=1
    ...
    private static void dfs(int[][] maps, int[] dx, int[] dy, int x, int y, boolean[][] visited, int move) {
        ...
        if (x == maps.length - 1 && y == maps[0].length - 1) {
            //System.out.println("(" + x + ", " + y + ")" + " / move=" + move);
