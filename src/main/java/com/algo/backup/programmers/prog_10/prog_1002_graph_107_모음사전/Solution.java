package com.algo.backup.programmers.prog_10.prog_1002_graph_107_모음사전;
...
public class Solution {
    ...
    private static void dfs(String[] words, String word, String curr) {
        if (word.equals(curr)) {
            answer = cnt;
            return;
        }
