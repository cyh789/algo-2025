package com.algo.backup.programmers.prog_10.prog_1013_dfsBfs_002_네트워크;
...
public class Solution {
    ...
    private static void dfs(int[][] computers, int idx, LinkedList<int[]> result, boolean[] visited) {
        visited[idx] = true;
