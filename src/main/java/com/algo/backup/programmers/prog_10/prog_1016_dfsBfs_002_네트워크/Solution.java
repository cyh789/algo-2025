package com.algo.backup.programmers.prog_10.prog_1016_dfsBfs_002_네트워크;
...
public class Solution {
    ...
    private static void bfs(int[][] computers, boolean[] visited, int idx) {
        ...
        while (!q.isEmpty()) {
            int currIdx = q.poll();
            if (currIdx >= computers.length) continue;
