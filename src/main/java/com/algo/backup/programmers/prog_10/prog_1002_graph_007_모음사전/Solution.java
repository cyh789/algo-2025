...
public class Solution {
    ...
    public static int solution(String word) {
        ...
        cnt = 0;
        answer = 0;
        dfs(words, word, curr, depth, visited);
    ...
    private static void dfs(String[] words, String word, String curr, int depth, boolean[] visited) {
        ...
        for (String s : words) {
            ...
            cnt++;
            visited[depth] = true;
            dfs(words, word, next, depth + 1, visited);
            visited[depth] = false;
