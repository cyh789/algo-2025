package com.algo.backup.programmers.prog_10.prog_1013_dfsBfs_104_단어_변환;
...
public class Solution {
    ...
    public static int solution(String begin, String target, String[] words) {
        ...
        String curr = begin;
        int cnt = 0;
        dfs(words, target, curr, visited, cnt);
        return minCnt == Integer.MAX_VALUE ? 0 : minCnt;
    }

    private static void dfs(String[] words, String target, String curr, boolean[] visited, int cnt) {
        ...
        for (int i = 0; i < words.length; i++) {
            ...
            visited[i] = true;
            dfs(words, target, next, visited, cnt + 1);
            visited[i] = false;
        }
