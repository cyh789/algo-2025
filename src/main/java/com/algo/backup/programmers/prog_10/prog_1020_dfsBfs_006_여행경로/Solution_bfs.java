package com.algo.backup.programmers.prog_10.prog_1020_dfsBfs_006_여행경로;
...
public class Solution_bfs {
    ...
    private static String[] bfs(String[][] tickets) {
        ...
        q.add(new Node(v1, v2, result, visited));
        ...
        while (!q.isEmpty()) {
            ...
            for (int i = 0; i < tickets.length; i++) {
                ...
                boolean[] nextVisited = Arrays.copyOf(currVisited, tickets.length);
                nextVisited[i] = true;;

                List<String> nextResult = new ArrayList<>(currResult);
                nextResult.add(nextV2);

                q.add(new Node(nextV1, nextV2, nextResult, nextVisited));
            }
        }
    ...
    private static final class Node {
        ...
        private Node(String v1, String v2, List<String> result, boolean[] visited) {
            this.v1 = v1;
            this.v2 = v2;
            this.result = result;
