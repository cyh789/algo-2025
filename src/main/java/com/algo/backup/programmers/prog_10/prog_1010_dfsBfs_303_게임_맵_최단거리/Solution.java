package com.algo.backup.programmers.prog_10.prog_1010_dfsBfs_303_게임_맵_최단거리;
...
public class Solution {
    ...
    public static int solution(int[][] maps) {
        ...
        int y = 0;
        int move = 1;
        return bfs(maps, x, y, move, dx, dy, visited);
    }

    private static int bfs(int[][] maps, int x, int y, int move, int[] dx, int[] dy, boolean[][] visited) {
        Queue<int[]> queue = new LinkedList<>();
        queue.add(new int[]{x, y, move});
