package com.algo.backup.programmers.prog_10.prog_1001_queueNstack_004_프로세스_999999999;
...
public class Solution {
    ...
    public static int solution(int[] priorities, int location) throws InterruptedException {
        Queue<int[]> queue = new LinkedList<>();    //int idx, int priority
        int maxPriority = 0;
        ...
        while (true) {
            ...
            if (stop) {
                ...
                pollCnt++;
                if (currIdx == location) return pollCnt;
            }
        }
    }
