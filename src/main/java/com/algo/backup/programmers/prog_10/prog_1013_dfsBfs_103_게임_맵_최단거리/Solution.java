package com.algo.backup.programmers.prog_10.prog_1013_dfsBfs_103_게임_맵_최단거리;
...
public class Solution {
    ...
    public static int solution(int[][] maps) {
        ...
        dfs(maps, dx, dy, currX, currY, cnt, visited);

        return minCnt == Integer.MAX_VALUE ? -1 : minCnt;
    }
    static int minCnt;

    private static void dfs(int[][] maps, int[] dx, int[] dy, int currX, int currY, int cnt, boolean[][] visited) {
        ...
        for (int i = 0; i < dx.length; i++) {
            ...
            dfs(maps, dx, dy, nextX, nextY, cnt + 1, visited);
