...
public class Solution_dfs {
    ...
    public static int solution(int[] numbers, int target) {
        ...
        int currDepth = 0;
        int sum = 0;
        dfs(numbers, target, currDepth, sum);

        return cnt;
    }

    private static void dfs(int[] numbers, int target, int currDepth, int sum) {
        ...
        dfs(numbers, target, currDepth + 1, sum + numbers[currDepth]);
        dfs(numbers, target, currDepth + 1, sum - numbers[currDepth]);
