package com.algo.backup.programmers.prog_10.prog_1013_dfsBfs_003_게임_맵_최단거리;
...
public class Solution {
    ...
    public static int solution(int[][] maps) {
        ...
        int cnt = 1;
        dfs(maps, currX, currY, dx, dy, visited, cnt);

        return minCnt == Integer.MAX_VALUE ? -1 : minCnt;
    }
    static int minCnt;

    private static void dfs(int[][] maps, int currX, int currY, int[] dx, int[] dy, boolean[][] visited, int cnt) {
        ...
        for (int i = 0; i < dx.length; i++) {
            ...
            dfs(maps, nextX, nextY, dx, dy, visited, cnt + 1);
