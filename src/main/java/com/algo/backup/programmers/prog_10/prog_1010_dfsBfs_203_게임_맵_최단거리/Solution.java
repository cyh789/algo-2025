package com.algo.backup.programmers.prog_10.prog_1010_dfsBfs_203_게임_맵_최단거리;
...
public class Solution {
    ...
    public static int solution(int[][] maps) {
        ...
        dfs(maps, x, y, dx, dy, visited, move);
    ...
    private static void dfs(int[][] maps, int x, int y, int[] dx, int[] dy, boolean[][] visited, int move) {
        if (minMove <= move) return;
        ...
        for (int i = 0; i < dx.length; i++) {
            ...
            dfs(maps, nextX, nextY, dx, dy, visited, move + 1);
